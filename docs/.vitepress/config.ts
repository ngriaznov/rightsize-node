    ...
    sidebar: [
      {
        ...
        items: [
          ...
          { text: "Failure diagnostics", link: "/guide/diagnostics" },
          { text: "Isolation", link: "/guide/isolation" },
          { text: "Checkpoint / restore", link: "/guide/checkpoints" },
          { text: "Cross-language parity", link: "/guide/parity" },
