...
function fakeBackend(name: string): SandboxBackend {
  ...
  return {
    ...
    capabilities: { hardwareIsolated: false, checkpoint: false, checkpointRestartsWorkload: false },
    ...
    copyToContainer: (): Promise<void> => notImplemented(),
    copyFromContainer: (): Promise<void> => notImplemented(),
